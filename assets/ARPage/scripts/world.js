var World = {
	...
	loadBasicData : function loadBasicDataFn(){
		...
		World.markerImageResource.push(new AR.ImageResource("images/ar_moseum.png"));
		...
		World.markerImageResourceSelected.push(new AR.ImageResource("images/ar_moseum_sel.png"));
